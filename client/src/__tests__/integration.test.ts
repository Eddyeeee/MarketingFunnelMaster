...
Object.defineProperty(window, 'location', {
  value: {
    href: 'http://localhost:3000/test?utm_source=affiliate&utm_medium=email&utm_campaign=magic_tool&utm_term=test&utm_content=banner&gclid=abc123&fbclid=def456',
    search: '?utm_source=affiliate&utm_medium=email&utm_campaign=magic_tool&utm_term=test&utm_content=banner&gclid=abc123&fbclid=def456',
    pathname: '/test'
  },
  writable: true
});
